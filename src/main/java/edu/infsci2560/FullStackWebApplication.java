...
public class FullStackWebApplication {
    ...
    public static void main(String[] args) {
        ...
        repository.save(new Note(1L, "Note1 for web", SchoolCode.INFSCI, 2560L, "mvc section"));
        repository.save(new Note(2L, "Note2 for web", SchoolCode.INFSCI, 2560L, "reposiitory section"));
        repository.save(new Note(3L, "Note3 for web", SchoolCode.INFSCI, 2560L, "git section"));
    }
}
